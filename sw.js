...
const VERSION = '0.19.2'; // keep equal to js/version.js
...
const FILES = [
  ...
  'js/views/rollcall.js',
  'js/views/settingsBackup.js',
  'js/views/settingsDestinations.js',
  'js/views/settingsExports.js',
  'js/views/settingsGuests.js',
